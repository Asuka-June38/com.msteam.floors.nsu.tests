...
Mobile.setText(findTestObject('testcases/android.widget.EditText0 - Search'), findTestData('nsuAssets').getValue(4, random.nextInt(
            312) + 1), 0)
...
Mobile.setText(findTestObject('testcases/android.widget.EditText1 (2)'), findTestData('nsuAssets').getValue(4, random.nextInt(
            312) + 1), 0)
